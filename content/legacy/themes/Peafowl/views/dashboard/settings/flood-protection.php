...
<div class="input-label"><i class="fas fa-info-circle"></i> <?php _se("Block file uploads by IP if the system notice a flood behavior based on the number of uploads per time period."); ?> <?php _se("This setting doesn't affect administrators."); ?></div>
