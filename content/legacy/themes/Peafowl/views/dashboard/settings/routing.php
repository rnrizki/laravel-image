...
<div class="input-label"><i class="fas fa-info-circle"></i> <?php _se('Routing allows you to customize default route binds on the fly. Only alphanumeric, hyphen and underscore characters are allowed.'); ?></div>
<div class="input-label">
    <label for="route_user"><?php _se('%s routing', _n('User', 'Users', 1)); ?></label>
...
<div class="input-label">
    <label for="route_image"><?php _se('%s routing', _n('Image', 'Images', 1)); ?></label>
    <div class="c9 phablet-c1">
...
<div class="input-label">
    <label for="route_video"><?php _se('%s routing', _n('Video', 'Videos', 1)); ?></label>
    <div class="c9 phablet-c1">
        <input type="text" name="route_video" id="route_video" class="text-input" value="<?php echo Settings::get('route_video'); ?>" required pattern="^[a-z0-9]+(?:-[a-z0-9]+)*$" placeholder="video">
    </div>
    <div class="input-below input-warning red-warning"><?php echo Handler::var('input_errors')['route_image'] ?? ''; ?></div>
    <div class="input-below"><?php _se('Routing for %s', get_base_url('video/&lt;id&gt;')); ?></div>
</div>
<div class="input-label">
    <label for="route_album"><?php _se('%s routing', _n('Album', 'Albums', 1)); ?></label>
    <div class="c9 phablet-c1">
    ...
    <div class="c5 phablet-c1"><select type="text" name="root_route" id="root_route" class="text-input">
        <?php
                foreach ([
                    ...
                    'album' => _n('Album', 'Albums', 1),
                    'image' => _n('Image', 'Images', 1) . ' | ' . _n('Video', 'Videos', 1),
                ] as $k => $v) {
