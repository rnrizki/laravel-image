...
<div class="input-label"><i class="fas fa-info-circle"></i> <?php _se("Shows a consent screen before accessing the website. Useful for adult content websites where minors shouldn't be allowed."); ?></div>
